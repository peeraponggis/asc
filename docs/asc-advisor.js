...
(function (global) {
...

    {
        ...
        run(d) {
            ...
            if (r.level === 'partial') return { level: 'warn',
                title: 'แบตเตอรี่เข้ากับอินเวอร์เตอร์ได้ไม่เต็มชุด',
                detail: r.why + ' กรณีนี้มักแก้ได้ด้วยการลดจำนวนโมดูลในตู้ลง ' +
                        'แต่ต้องระบุจำนวนโมดูลที่ใช้จริงให้ชัดในแบบ ไม่ใช่สั่งตามความจุรวมของตู้เต็ม',
                evidence: ev,
                fix: ['ระบุจำนวนโมดูลที่ทำให้แรงดันอยู่ในช่วงของอินเวอร์เตอร์ แล้วเขียนไว้ในแบบ'],
                kb: 'battery-match' };
