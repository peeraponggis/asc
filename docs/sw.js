...
const VERSION = 'mobi-v10';
/* แคชไฟล์ของแอปมือถือ และใบสั่งงานช่างซึ่งช่างต้องเปิดที่ไซต์งานที่มักไม่มีสัญญาณ
   หน้ารากยังเป็นหน้าล็อกอินของ ASC ซึ่งเป็นคนละโปรแกรมและไม่ต้องใช้ออฟไลน์

   ใบสั่งงานช่างแคชได้อย่างปลอดภัยเพราะข้อมูลโครงการไม่ได้อยู่ในไฟล์ HTML
   ตัวหน้ารับข้อมูลจาก master_shell หรือจากไฟล์ DB2 ที่เปิดเอง ส่วนรูปกับ
   เช็กลิสต์อยู่ใน IndexedDB ของเครื่อง แคชค้างจึงไม่ทำให้เห็นข้อมูลเก่า
   และกลยุทธ์ stale-while-revalidate จะดึงตัวใหม่มาให้ในการเปิดครั้งถัดไป */
const SHELL = [
  './mobi.html',
  './asc_brief.html',
  './asc-brief-store.js',
